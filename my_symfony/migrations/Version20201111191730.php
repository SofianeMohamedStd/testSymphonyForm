 ...
 */
final class Version20201111191730 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('ALTER TABLE commercant ADD CONSTRAINT FK_ECB4268F9F34925F FOREIGN KEY (id_categorie_id) REFERENCES categorie (id)');
